...
namespace IM10.BAL.Implementaion
{
    ...
    public class UserService : IUserService
    {
        ...
        public UserService(IM10DbContext _context, IEmailSenderService emailSender, IOptions<ConfigurationModel> hostName, IAuthService authService, IUserAuditLogService userAuditLogService)
        {
            context = _context;
        ...
        {            
            ...
            if (userentity == null)
            {
                ...
                userEntity.Password = EncryptionHelper.Encrypt(user.Password.ToString());
            ...
            {
                if (userentity.EmailId == user.EmailId)
                {
            ...
            userAuditLog.Description = "User Added";
        ...
        public string EditUser(UserModel users, ref ErrorResponseModel errorResponseModel)
        {
            ...
            if (userEntity != null)
            {
                ...
                {
                    var userEntity2 = context.UserMasters.Where(x => x.EmailId == users.EmailId && x.IsDeleted == false).FirstOrDefault();
                    if (userEntity2 != null)
                    {
                ...
                userEntity.MobileNo = users.MobileNo;
                userEntity.Dob = users.Dob;
                userEntity.Password = EncryptionHelper.Encrypt(users.Password.ToString());
        ...
        public string ForgetPassword(string email, ref ErrorResponseModel errorResponseModel)
        {
            ...
            userAuditLog.Description = "Forgot password";
            userAuditLog.UserId = (int)userEntity.CreatedBy;
            userAuditLog.UpdatedBy = userEntity.UpdatedBy;
            userAuditLog.UpdatedDate = DateTime.Now;
            _userAuditLogService.AddUserAuditLog(userAuditLog);
        ...
        public string ChangePassword(changepasswordModel userModel, ref ErrorResponseModel errorResponseModel)
        {
            ...
            if (userEntity != null)
            {
                userEntity.Password = EncryptionHelper.Encrypt(userModel.Password.ToString());
                context.UserMasters.Update(userEntity);
                context.SaveChanges();
            ...
            userAuditLog.Description = "Password Changed";
            userAuditLog.UserId = (int)userEntity.CreatedBy;
            userAuditLog.UpdatedBy = userEntity.UpdatedBy;
            userAuditLog.UpdatedDate = DateTime.Now;
            _userAuditLogService.AddUserAuditLog(userAuditLog);
        ...
        public string AddMobileUser(MobileUserRegisterModel model, ref ErrorResponseModel errorResponseModel)
        {
            ...
            userAuditLog.Description = "Mobile User Added";
        ...
        public string ActivateUser(ActiveUserModel model, ref ErrorResponseModel errorResponseModel)
        {
            ...
            userAuditLog.Description = "Mobile User Activated";
